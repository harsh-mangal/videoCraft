...
import { managedImageUrl } from "../utils/images";
import { useMediaImage } from "../components/MediaProvider";
...
const AboutUs = () => {
    const background = useMediaImage("https://ik.imagekit.io/sqpcbo0c0/Video%20Craft/455841250_18292334629201135_8028869471403628683_n.jpg?updatedAt=1758102107890");
    ...
    return (
        <>
            ...
            <section
                ...
                style={{
                    backgroundImage: "url(" + managedImageUrl(background, 1600) + ")",
                }}
            >
